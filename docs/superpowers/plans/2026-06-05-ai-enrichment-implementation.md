...
**Goal:** Build a generic AI enrichment layer for DataFlow, enabled first for the stocks topic, with encrypted model configs, item-level enrichment, topic-level AI daily highlights, admin visibility, and public-page presentation.
