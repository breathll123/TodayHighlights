...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("related_symbols_json", sa.JSON(), nullable=False, server_default=sa.text("'[]'")),
        sa.Column("importance_score", sa.Integer(), nullable=False, server_default=sa.text("0")),
        sa.Column("focus_points_json", sa.JSON(), nullable=False, server_default=sa.text("'[]'")),
        sa.Column("risk_points_json", sa.JSON(), nullable=False, server_default=sa.text("'[]'")),
