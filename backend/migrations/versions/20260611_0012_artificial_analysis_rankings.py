...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("requested_by_user_id", sa.BigInteger().with_variant(sa.Integer(), "sqlite"), nullable=True),
        sa.Column("requested_datasets_json", sa.JSON(), nullable=False, server_default=sa.text("'[]'")),
        sa.Column("completed_datasets_json", sa.JSON(), nullable=False, server_default=sa.text("'[]'")),
        sa.Column("failed_datasets_json", sa.JSON(), nullable=False, server_default=sa.text("'[]'")),
    ...
    op.create_table(
        ...
        sa.Column("response_headers_json", sa.JSON(), nullable=False, server_default=sa.text("'{}'")),
    ...
    op.create_table(
        ...
        sa.Column("parser_warnings_json", sa.JSON(), nullable=False, server_default=sa.text("'[]'")),
    ...
    op.create_table(
        ...
        sa.Column("pricing_json", sa.JSON(), nullable=False, server_default=sa.text("'{}'")),
        sa.Column("performance_json", sa.JSON(), nullable=False, server_default=sa.text("'{}'")),
